...
namespace Lemonad.ErrorHandling.Test.Maybe.Tests {
    public class SelectManyTests {
        ...
        public void Enumerable_ResultSelector_SelectMany_FlatMap_Maybe_With_Value() {
            ...
            var list = Enumerable
                .Range(0, 3)
                .SelectMany(_ => input.ToMaybeNone(string.IsNullOrWhiteSpace).AsEnumerable, (x, y) => x + y.Length)
                .ToList();
        ...
        public void Enumerable_ResultSelector_SelectMany_FlatMap_Maybe_Without_Value() {
            ...
            var list = Enumerable
                .Range(0, 3)
                .SelectMany(_ => input.ToMaybe(y => y.Length > 10).AsEnumerable, (x, y) => x + y.Length)
                .ToList();
        ...
        public void Predicate_Overload__Passing_Null_Predicate__Throws_ArgumentNullException() {
            Assert.Throws<ArgumentNullException>(() => {
                ...
                "foo".ToMaybe().AsEnumerable.SelectMany(func);
            });
        }
    }
}