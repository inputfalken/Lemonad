...
namespace Lemonad.ErrorHandling.Test.Asynchronous.Result.Tests {
    public class FlattenTests {
        ...
        public async Task
            ...
            var flattenAsync = DivisionAsync(2, 0).Flatten(x => {
        ...
        public async Task
            ...
            var flatSelectorExecuted = false;
            var errorSelectorExecuted = false;
            var flatten = DivisionAsync(2, 0).Flatten(x => {
                flatSelectorExecuted = true;
        ...
        public async Task
            ...
            var flatSelectorExecuted = false;
            var errorSelectorExecuted = false;
            var flatMap = DivisionAsync(2, 2).Flatten(x => {
                flatSelectorExecuted = true;
                return DivisionAsync(x, 0);
            }, s => {
                errorSelectorExecuted = true;
        ...
        public async Task
            ...
            var flatSelectorExecuted = false;
            var flattenAsync = DivisionAsync(2, 2).Flatten(x => {
                flatSelectorExecuted = true;
                return DivisionAsync(x, 0);
            });
            Assert.False(flatSelectorExecuted,
        ...
        public async Task
            ...
            Assert.False(flatSelectorExecuted, "flatmapselector should not get executed before the value is awaited.");
            var result = await flattenAsync;
        ...
        public async Task
            ...
            Assert.False(errorSelectorExecuted, "Errorselector should not get executed before the value is awaited.");
            var result = await flattenAsync;
