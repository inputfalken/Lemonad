...
namespace Lemonad.ErrorHandling.Extensions {
    public static class OutcomeExtensions {
        [Pure]
        public static Outcome<TResult, TError> Map<T, TResult, TError>(this Task<Result<T, TError>> source,
            Func<T, TResult> selector) => TaskResultFunctions.Map(source, selector);

        [Pure]
        public static Outcome<T, TErrorResult> MapError<T, TError, TErrorResult>(
            this Task<Result<T, TError>> source, Func<TError, TErrorResult> selector) =>
            TaskResultFunctions.MapError(source, selector);

        [Pure]
        public static Outcome<TResult, TErrorResult> FullMap<T, TResult, TError, TErrorResult>(
        ...
        public static Outcome<T, TError> Do<T, TError>(this Task<Result<T, TError>> source, Action action) =>
            TaskResultFunctions.Do(source, action);

        public static Outcome<T, TError> DoWithError<T, TError>(
            this Task<Result<T, TError>> source,
            Action<TError> action) => TaskResultFunctions.DoWithError(source, action);

        public static Outcome<T, TError> DoWith<T, TError>(
            this Task<Result<T, TError>> source,
            Action<T> action) =>
            TaskResultFunctions.DoWith(source, action);

        [Pure]
        public static Outcome<T, TError> Filter<T, TError>(
            this Task<Result<T, TError>> source,
        ...
        [Pure]
        public static Outcome<T, TError> IsErrorWhen<T, TError>(
            this Task<Result<T, TError>> source,
            Func<T, bool> predicate,
            Func<TError> errorSelector) =>
        ...
        [Pure]
        public static Outcome<T, TError> IsErrorWhenNull<T, TError>(
            this Task<Result<T, TError>> source,
            Func<TError> errorSelector) =>
            TaskResultFunctions.IsErrorWhenNull(source, errorSelector);

        [Pure]
        public static Outcome<T, TError> Flatten<T, TResult, TError, TErrorResult>(
        ...
        [Pure]
        public static Outcome<T, TError> Flatten<T, TError, TResult>(
            this Task<Result<T, TError>> source,
            Func<T, Task<Result<TResult, TError>>> selector) =>
            TaskResultFunctions.Flatten(source, selector);

        [Pure]
        public static Outcome<TResult, TErrorResult> FullFlatMap<T, TError, TResult, TErrorResult>(
            this Task<Result<T, TError>> source,
        ...
        [Pure]
        public static Outcome<TResult, TErrorResult> FullFlatMap<T, TError, TFlatMap, TResult, TErrorResult>(
            this Task<Result<T, TError>> source,
        ...
        [Pure]
        public static Outcome<TResult, TError> FlatMap<T, TResult, TError>(
            this Task<Result<T, TError>> source,
        ...
        [Pure]
        public static Outcome<TResult, TError> FlatMap<T, TSelector, TResult, TError>(
            this Task<Result<T, TError>> source,
        ...
        [Pure]
        public static Outcome<TResult, TError> FlatMap<T, TResult, TError, TErrorResult>(
            this Task<Result<T, TError>> source,
        ...
        [Pure]
        public static Outcome<TResult, TError> FlatMap<T, TError, TFlatMap, TResult, TErrorResult>(
            this Task<Result<T, TError>> source,
            Func<T, Result<TFlatMap, TErrorResult>> flatMapSelector, Func<T, TFlatMap, TResult> resultSelector,
            Func<TErrorResult, TError> errorSelector) =>
