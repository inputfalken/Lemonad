...
namespace Lemonad.ErrorHandling.Test.Result.Tests.Internal.Asynchronous.Result.Tests {
    public class DoWithErrorTests {
        ...
        public async Task
            ...
            var doWithError = TaskResultFunctions.DoWithError(AssertionUtilities.DivisionAsync(10, 0), d => actionExectued = true);
        ...
        public async Task
            ...
            var actionExectued = false;
            var doWithError = TaskResultFunctions.DoWithError(AssertionUtilities.DivisionAsync(10, 2), d => actionExectued = true);
            var result = await doWithError;
