...
namespace Lemonad.ErrorHandling.Test.AsyncResult.Tests {
    public class MatchTests {
        ...
        public async Task Result_With_Error__Expect_ErrorAction() {
            ...
            await DivisionAsync(10, 0).Match(d => { selectorExectued = true; }, s => { errorSelectorExectued = true; });
        ...
        public async Task
            ...
            var selectorExectued = false;
            var errorSelectorExectued = false;
            await DivisionAsync(10, 2).Match(d => { selectorExectued = true; }, s => { errorSelectorExectued = true; });
