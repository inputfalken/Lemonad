    ...
    public class FlatMapResultSelectorTests {
        ...
        public void
            ...
            var exception = Record.Exception(() => {
                var result = EitherParsers.Int("foo")
                    .FlatMap(i => EitherParsers.Bool("x"), resultSelector);
        ...
        public void
            ...
            var exception = Record.Exception(() => {
                var result = EitherParsers.Int("foo").FlatMap(selector, (x, y) => x + y);
                Assert.False(result.IsRight, "Either should not have a right value.");
                Assert.True(result.IsLeft, "Either should have a left value.");
                Assert.Equal("Could not parse type System.String(\"foo\") into System.Int32.", result.Left);
            });
        ...
        public void
            ...
            var exception = Record.Exception(() => {
                var result = EitherParsers.Int("foo").FlatMap(selector, resultSelector);
                Assert.False(result.IsRight, "Either should not have a right value.");
                Assert.True(result.IsLeft, "Either should have a left value.");
                Assert.Equal("Could not parse type System.String(\"foo\") into System.Int32.", result.Left);
            });
        ...
        public void
            ...
            Func<int, int, int> resultSelector = null;
            var exception = Record.Exception(() => {
                var result = EitherParsers.Int("2")
                    .FlatMap(i => EitherParsers.Int("foo"), resultSelector);
                Assert.False(result.IsRight, "Either should not have a right value.");
                Assert.True(result.IsLeft, "Either should have a left value.");
                Assert.Equal("Could not parse type System.String(\"foo\") into System.Int32.", result.Left);
            });
        ...
        public void
            ...
            Assert.Throws<ArgumentNullException>(() => {
                var result = EitherParsers.Int("2").FlatMap(selector, (x, y) => x + y);
                Assert.False(result.IsRight, "Either should not have a right value.");
                Assert.True(result.IsLeft, "Either should have a left value.");
                Assert.Equal("Could not parse type System.String(\"foo\") into System.Int32.", result.Left);
            });
        ...
        public void
            ...
            Func<int, int, int> resultSelector = null;
            Assert.Throws<ArgumentNullException>(() => {
                var result = EitherParsers.Int("2").FlatMap(selector, resultSelector);
                Assert.False(result.IsRight, "Either should not have a right value.");
                Assert.True(result.IsLeft, "Either should have a left value.");
                Assert.Equal("Could not parse type System.String(\"foo\") into System.Int32.", result.Left);
            });
        ...
        public void
            ...
            var intParse = EitherParsers.Int("foo");
            var doubleParse = EitherParsers.Double("2.2");
